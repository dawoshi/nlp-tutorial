#ifndef MODEL_TOKENIZATION_H
#define MODEL_TOKENIZATION_H
 ...
 */
    ...
    public:
        ...
        void convert_tokens_to_ids(const std::vector<std::string> &tokens, std::vector<uint64_t> &ids);
